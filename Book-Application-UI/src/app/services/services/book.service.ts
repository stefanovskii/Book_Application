...
import { findAllBorrowedBooksByOwner } from '../fn/book/find-all-borrowed-books-by-owner';
import { FindAllBorrowedBooksByOwner$Params } from '../fn/book/find-all-borrowed-books-by-owner';
import { findAllReturnedBooksByOwner } from '../fn/book/find-all-returned-books-by-owner';
import { FindAllReturnedBooksByOwner$Params } from '../fn/book/find-all-returned-books-by-owner';
...
export class BookService extends BaseService {
   ...
   * This method doesn't expect any request body.
   */
  findAllReturnedBooksByOwner$Response(params?: FindAllReturnedBooksByOwner$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBorrowedBookResponse>> {
    return findAllReturnedBooksByOwner(this.http, this.rootUrl, params, context);
  }
   ...
   * This method doesn't expect any request body.
   */
  findAllReturnedBooksByOwner(params?: FindAllReturnedBooksByOwner$Params, context?: HttpContext): Observable<PageResponseBorrowedBookResponse> {
    return this.findAllReturnedBooksByOwner$Response(params, context).pipe(
   ...
   * This method doesn't expect any request body.
   */
  findAllBorrowedBooksByOwner$Response(params?: FindAllBorrowedBooksByOwner$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBorrowedBookResponse>> {
    return findAllBorrowedBooksByOwner(this.http, this.rootUrl, params, context);
  }
   ...
   * This method doesn't expect any request body.
   */
  findAllBorrowedBooksByOwner(params?: FindAllBorrowedBooksByOwner$Params, context?: HttpContext): Observable<PageResponseBorrowedBookResponse> {
    return this.findAllBorrowedBooksByOwner$Response(params, context).pipe(
      map((r: StrictHttpResponse<PageResponseBorrowedBookResponse>): PageResponseBorrowedBookResponse => r.body)
    );
  }
